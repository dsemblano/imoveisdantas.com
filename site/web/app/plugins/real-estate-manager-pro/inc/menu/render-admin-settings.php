<?php
    ...
    switch ($field['type']) {
        ...
        case 'text': ?>
            ...
            <div class="form-group wrap_<?php echo $field['name']; ?>" <?php echo $c_data; ?>>
        ...
        case 'textarea':
            ...
            <div class="form-group wrap_<?php echo $field['name']; ?>" <?php echo $c_data; ?>>
                <label for="<?php echo $field['name']; ?>" class="col-sm-4 control-label"><?php echo $field['title']; ?></label>
                <div class="col-sm-8">
                    <textarea <?php echo $disabled; ?> name="<?php echo $field['name']; ?>" class="form-control" id="<?php echo $field['name']; ?>"><?php echo (is_array($field_value)) ? implode("\n", $field_value) : $field_value; ?></textarea>
        ...
        case 'select': ?>
            ...
            <div class="form-group wrap_<?php echo $field['name']; ?>" <?php echo $c_data; ?>>
                <label for="<?php echo $field['name']; ?>" class="col-sm-4 control-label"><?php echo $field['title']; ?></label>
                <div class="col-sm-8">
                    <select <?php echo $multiple; ?> name="<?php echo $field_name; ?>" id="<?php echo $field['name']; ?>" class="form-control input-sm">
                        <?php
