    ...
    array(
        ...
        'fields'        => array(
            ...
            array(
                ...
                'options' => array(
                    'fotorama' => __( 'Slider with Thumbnails', 'real-estate-manager' ),
                    'slick' => __( 'Simple Slider', 'real-estate-manager' ),
                    'grid' => __( 'Grid with Popup', 'real-estate-manager' ),
                ),
            ),
            array(
                'type' => 'text',
        ...
        'fields'        => array(
            ...
            array(
                ...
                'options' => array(
                    ...
                    'min_max_dropdown' => __( 'Range Dropdown', 'real-estate-manager' ),
                )
            ),
             array(
                'type' => 'textarea',
                ...
                'show_if'  => array('search_price_range', 'min_max_dropdown'),
            ),
            array(
                'type' => 'select',
    ...
    array(
        ...
        'fields'        => array(
            ...
            array(
                ...
                'help' => __( 'Provide email markup here. You can also use these special tags.', 'real-estate-manager' ). '<code>%property_title%</code>, <code>%property_id%</code>, <code>%user_message%</code>, <code>%user_email%</code>, <code>%phone%</code>, <code>%property_url%</code>',
            ),
