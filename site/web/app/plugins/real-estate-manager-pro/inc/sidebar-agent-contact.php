<?php $agent_card_style = rem_get_option('agent_card_style', '1');  ?>
		...
		<?php
			...
			if ($custom_form != '') {
				...
				<form method="post" class="contact-agent-form" data-ajaxurl="<?php echo admin_url( 'admin-ajax.php' ); ?>" role="form" data-toggle="validator">
					...
					<div class="form-group">
						<input <?php echo esc_attr( $intlTelInputVars ); ?> type="<?php echo $phone_field; ?>" placeholder="<?php _e( 'Phone', 'real-estate-manager' ); ?>" class="form-control" name="client_phone" id="phone">
					</div>
					<div class="form-group">
