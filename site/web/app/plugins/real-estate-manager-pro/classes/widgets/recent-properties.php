...
class REM_Recent_Properties extends WP_Widget {
	...
	public function form( $instance ) {
		...
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'total' ) ); ?>"><?php _e( 'Number of Properties','real-estate-manager' ); ?></label> 
			<input
				class="widefat"
		...
		<p>
			...
			>
			<label for="<?php echo esc_attr( $this->get_field_id( 'display_date' ) ); ?>"><?php _e( 'Display Date','real-estate-manager' ); ?></label> 
		</p>
		<p>
			<input
				class="widefat"
			...
			>
			<label for="<?php echo esc_attr( $this->get_field_id( 'display_current' ) ); ?>"><?php _e( 'Enable Current Property','real-estate-manager' ); ?></label> 
		</p>
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'custom_data' ) ); ?>"><?php _e( 'Custom Data (Provide field name)','real-estate-manager' ); ?></label> 
			<input
				class="widefat"
