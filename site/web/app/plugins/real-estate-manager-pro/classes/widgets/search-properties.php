...
class REM_Search_Property_Widget extends WP_Widget {
	...
	public function form( $instance ) {
		...
		<p>
			...
			>
			<label for="<?php echo esc_attr( $this->get_field_id( 'auto_complete' ) ); ?>"><?php _e( 'Enable Auto Complete Fields','real-estate-manager' ); ?></label> 
			<br>
			<i><?php _e( 'It will auto suggest words in text fields as user type in.', 'real-estate-manager' ); ?></i>
		</p>
		<p>
