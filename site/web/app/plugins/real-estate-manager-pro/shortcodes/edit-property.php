					...
					<div class="row">
						...
						<div class="col-sm-6 col-md-4">
							<select name="accessibility" class="form-control">
								<option value=""> -- <?php _e( 'Accessibility', 'real-estate-manager' ); ?> -- </option>
								<option <?php echo (get_post_status($property_id) == 'draft') ? 'selected' : '' ; ?> value="draft"><?php _e( 'Draft', 'real-estate-manager' ); ?></option>
								<option <?php echo (get_post_status($property_id) == 'publish') ? 'selected' : '' ; ?> value="publish"><?php _e( 'Publish', 'real-estate-manager' ); ?></option>
							</select>
						</div>
						<?php } else { ?>
							<div class="col-sm-12 col-md-12">
