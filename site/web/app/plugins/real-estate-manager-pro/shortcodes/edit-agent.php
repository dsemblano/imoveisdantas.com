...
<form action="" id="agent-profile-form">
	...
	<?php echo ($tab_name != 'personal_info') ? '<br>' : '' ; ?>
		...
		<?php if (rem_get_option('agent_location') == 'enable') {
			?>
			<input type="hidden" id="agent_longitude" name="agent_longitude" value="<?php echo $agent_longitude; ?>">
			<input type="hidden" id="agent_latitude" name="agent_latitude" value="<?php echo $agent_latitude; ?>">
