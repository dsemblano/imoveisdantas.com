...
<div class="ich-settings-main-wrap">
	...
	<section id="<?php echo $map_id; ?>" class="rem-maps">
		...
		<?php if ($type_filtering == 'enable') { $all_types = explode(",", $filter_options); ?>
			<div class="rem-filters-overlay" id="filtering-<?php echo $map_id; ?>">
				<?php foreach ($all_types as $p_type) { ?>
					<label><input type="checkbox" name="filter_by" value="<?php echo $p_type; ?>" data-type="<?php echo $p_type; ?>"> <?php echo $p_type; ?> </label>
				<?php } ?>
			</div>
		<?php } ?>
	</section>
	<?php } else { ?>
		<div class="rem-leaflet-map-area" id="<?php echo $map_id; ?>"></div>
	<?php } ?>
</div>