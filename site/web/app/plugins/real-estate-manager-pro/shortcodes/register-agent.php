			...
			<div class="row">
				<div class="col-sm-12">
					...
					foreach ($field_tabs as $tab_name => $tab_title) {
						...
						<div class="tab-wrap-<?php echo $tab_name; ?>"></div>
						<div class="section-title line-style no-margin <?php echo $tab_name; ?>">
					...
					<?php if (rem_get_option('agent_location') == 'enable') { ?>
						...
						<div class="section-title line-style no-margin location">
							<h3 class="title"><?php _e( 'Location', 'real-estate-manager' ); ?></h3>
						</div>
						<ul class="profile create">
				...
				<?php if ($required_text != '') { ?>
					<div class="col-sm-12">
						<label><input type="checkbox" required> <?php echo $required_text; ?></label>
					</div>
				<?php } ?>
				<?php do_action( 'rem_register_agent_before_register_button' ); ?>
					<div class="col-sm-12">
						<button class="btn btn-default signin-button" type="submit"><i class="far fa-hand-point-right"></i> <?php _e( 'Sign up', 'real-estate-manager' ); ?></button>
					</div>
			</div>
		</section>
	</form>
