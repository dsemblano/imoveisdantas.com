    ...
    <div class="block-center">
        <div class="block-center-inner">
            <?php if (isset($logo_loading['url']) && !empty($logo_loading['url'])) : ?>
                <img class="logo-loading" alt="<?php esc_html_e('Logo Loading','g5-beyot') ?>" src="<?php echo esc_url($logo_loading['url']) ?>" width="<?php echo esc_attr($logo_loading['width']); ?>" height="<?php echo esc_attr($logo_loading['height']); ?>" />
            <?php endif; ?>
